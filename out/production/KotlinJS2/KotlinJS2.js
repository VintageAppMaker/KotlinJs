if (typeof kotlin === 'undefined') {
  throw new Error("Error loading module 'KotlinJS2'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'KotlinJS2'.");
}
var KotlinJS2 = function (_, Kotlin) {
  'use strict';
  ...
  clickCount = 0;
  main([]);
  Kotlin.defineModule('KotlinJS2', _);
  return _;
}(typeof KotlinJS2 === 'undefined' ? {} : KotlinJS2, kotlin);
